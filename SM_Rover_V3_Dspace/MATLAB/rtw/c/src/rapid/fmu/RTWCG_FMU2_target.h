...
struct FMU2_CSME_RTWCG {
    /* isLoggingOn, fmuname, ssPtr are defined on top of the struct so that it aligns FMU2_CSME_RTWCG and FMU2_loggerEnv*/
    bool isLoggingOn;
    char* fmuname;
    #if FMU_CG_TARGET < FMUCG_STANDALONE_TARGETS
    SimStruct *ssPtr;
...
void FMU2_deserializeFMUstate(void** fmuv, const char* byteArray, size_t size, void** fmustate);
