...
void slcsInvokeStubFunction(SimStruct* S,
                            void* stubFcn,
                            _ssFcnCallExecArgInfo* args)
{
    (void)S;
...
void* slcsInitStubFunction(
    SimStruct* S,
    const char* encodedFullPathToModel,
    const char* fcnName,
    const char* encodedFullPathToFunction)
{
    (void)S;
    (void)encodedFullPathToModel;
    (void)fcnName;
    (void)encodedFullPathToFunction;
    return NULL;
}

void *slcsInitProxyFunction(
    SimStruct* S,
    const char* encodedFullPathToModel,
    const char* fcnName,
    const char* encodedFullPathToFunction,
...
void slcsDestroyStubFunction(void* stubFcn)
{
    (void)stubFcn;
}

void slcsDestroyProxyFunction(void* proxyFcn)
{
    (void)proxyFcn;
}
