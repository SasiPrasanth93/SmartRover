 ...
 *
 * \param[out]  numelWorkspaceCoefficients   Workspace size for floating-point quantities.
 * \param[out]  numelWorkspaceIndices   Workspace size for MFL_INTERP_UINT quantities.
 ...
 * \param[in]  N                  Number of dimensions of underlying N-D grid, i.e., \p N.
 *
 * \param[out]  numelWorkspaceEvaluation   Workspace size for floating-point quantities.
 * \param[out]  numelWorkspaceIndices   Workspace size for MFL_INTERP_UINT quantities.
 */
 ...
 *                       where <tt>x1, ..., xN </tt> are the \p N vectors defining the N-D grid.
 *
 * \param[out]  numelFloatingPointWS   Workspace size for floating-point quantities.
 * \param[out]  numelUnsignedIntWS   Workspace size for MFL_INTERP_UINT quantities.
 */
 ...
 *
 * \param[in]  gridSize  Number of 1-D grid coordinates.
 *
 * \param[out] numelWorkspace  Workspace size for floating-point quantities.
 */
